...
class BooksRepositoryImpl implements BooksRepository {
  ...
  Future<Book?> getBook(String bookId) async {
    try {
      ...
      final cachedBook = cacheResult.hasData 
          ? Book.fromMap(bookId, cacheResult.data!) 
          : null;
      ...
      await _cacheService.cacheData(
        key: bookCacheKey,
        data: bookWithHeadings.toMap(), // persist full object incl. headings
         boxName: CacheConstants.booksBoxName,
      ...
      for (final heading in headings) {
        ...
        final headingCacheKey = '${CacheConstants.headingKeyPrefix}${bookId}_main_main_${heading.id}';
        await _cacheService.cacheData(
          key: headingCacheKey,
          data: heading.toMap(),
