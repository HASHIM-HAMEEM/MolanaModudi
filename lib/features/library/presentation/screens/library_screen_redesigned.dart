      ...
      children: [
        ...
        AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: isSepia
                ? AppColor.backgroundSepia.withOpacity(0.3)
                : isDark
  ...
  Widget _buildViewModeButton({
    ...
    final decoration = isSelected
        ? BoxDecoration(
            ...
            border: Border.all(
              color: primaryColor.withOpacity(isDark ? 0.7 : 0.8),
              width: 1.5,
            ),
          )
        : BoxDecoration(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Icon(
                    ...
                    color: isSelected 
                        ? primaryColor
                        : textColor.withOpacity(isDark ? 0.8 : 0.65),
                ...
                child: SizedBox(
                  ...
                  child: CircularProgressIndicator(
                    ...
                    backgroundColor: isDark 
                        ? Colors.grey[800] 
                        : isSepia 
                            ? AppColor.backgroundSepia.withOpacity(0.2)
                            : Colors.grey[200],
                  ),
                ),
              ),
