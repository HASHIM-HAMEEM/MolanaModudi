...
import 'package:modudi/features/book_detail/data/repositories/book_detail_repository_impl.dart';
...
class BookDetailNotifier extends StateNotifier<BookDetailState> {
  ...
  Future<void> fetchAiEnhancedDetails() async {
    ...
    try {
      ...
      if (summaryData == null) {
        throw Exception('Failed to generate book summary. The AI model may be unavailable.');
      }
      ...
      if (recommendations == null) {
        // We'll continue even if recommendations fail - just log it
        _log.warning('Failed to generate recommendations, but summary was successful');
      }
